*--------------------------------------------------------------------------------
* HAL Open Communications (HALOC) Project					*
*										*
* HALOC is a application utilizing posts and hashtags to			*
* facilitate communication within a company environment.			*
* 										*
* AUTHORS: Bryce Cooper, Corey Geesey, Paul Kubitschek, Mai Van Pham		*
* 										*
* 										*
* A test running copy is located at http://haloc.no-ip.net/			*
* 										*
* 										*
* Additionally, further changes will be demonstrated at that address as		*
* updates/bug fixes are being made.						*
*										*
* Please submit bug reports, feature requests, etc. to the github repository	*
*										*
*										*
* DOCUMENTATION: Can be found in the Github repository located at:		*
* - https://github.com/pkubitsc/Computer_Systems_Initiative			*
* 										*
* 										*
*--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
 ...
 - Access to WAN (For jQuery use)

 - SMTP Email Server (Open Ports 465 and/or 25 on your web host if accessing remote SMTP server)
...
--------------------------------------------------------------------------------
1. The project and all subsequent changes can be downloaded from the Github repository located at https://github.com/pkubitsc/Computer_Systems_Initiative
...
4. Open the config.php file located at /project/applications/config/config.php and edit $config['base_url'] with the URL of your website.


5. If you would like, you can change the $config variables under the following titles (please read the comments):
 - Session variables (not sess_table_name though)
 - Cookie Related Variables
 - Output Compression
 - Master Time Reference


6. Open the tank_auth.php file located at /project/applications/config/tank_auth.php and edit$config['webmaster_email'] to the email address that emails will be sent from


7. Open the email.php file located at /project/applications/config/email.php and add your smtp server information.


8. Please be sure that the directories /project/images/user_images/ and all subdirectories within that directory are CHMOD read, write by the user


9. Open up your browser and browse to the base url. You are all set up!
...
Preamble: This Agreement, signed on Dec 14, 2013 [hereinafter: Effective Date] governs the relationship between HAL, a duly registered company, (hereinafter: Licensee) and CSI, a duly registered company in United States whose principal place of business is United States (Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using [HALOC] (hereinafter: The Software) created and owned by Licensor, as detailed herein
License Grant: Licensor hereby grants Licensee a Personal, Assignable, Commercial, Royalty free, Including the rights to create but not distribute derivative works, Non-exclusive license, all with accordance with the terms set forth and other legal restrictions set forth in 3rd party software used while running Software.
...
We agree to provide support for up to two years following the termination of development noted by the date of delivery of the product to HAL.
