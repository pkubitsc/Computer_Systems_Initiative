...
$config['username_max_length'] = 30;
$config['password_min_length'] = 4;
$config['password_max_length'] = 20;

$config['first_name_min_length'] = 2;
$config['first_name_max_length'] = 40;
$config['last_name_min_length'] = 2;
$config['last_name_max_length'] = 40;
$config['biography_min_length'] = 0;
$config['biography_max_length'] = 255;
...
$config['login_max_attempts'] = 4;
$config['login_attempt_expire'] = 60*60;
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'autologin_HALOC';
