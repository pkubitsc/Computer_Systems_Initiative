...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>css/changepassword/demo.php?url=<?php echo $base_url; ?>" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>css/changepassword/demo.php?url=<?php echo $base_url; ?>" media="all" />
    <link href="<?php echo $base_url; ?>css/changepassword/style.php?url=<?php echo $base_url; ?>" rel="stylesheet" type="text/css" media="screen" />
    <link href="<?php echo $base_url; ?>css/changepassword/style.php?url=<?php echo $base_url; ?>" rel="stylesheet" type="text/css" media="screen" />
