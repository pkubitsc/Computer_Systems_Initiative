...
<<<<<<< HEAD
        ...
        function view_hashtag_profile() {
                ...
                $data['posts'] = $this->hashtag_url_generator($this->posts->get_posts_by_hashtag_id($hashtag_id, $page));
        ...
        function followed() {
                ...
                $data['posts'] = $this->hashtag_url_generator($this->posts->get_followed_posts($user_id, $page));
