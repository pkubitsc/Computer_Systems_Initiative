...
.form input[type="submit"]{ margin-left: 20px; 	margin-top: 22px; width: 70px;}
.form input.birthday{width:60px;}
.form input.birthyear{width:100px;}
.form label { float: left; color: #000; font-weight:bold;font-size: 16px;font-family:Arial, Helvetica; line-height: 75px; margin-left: 10px;}
